...
# Plan definitions (monthly limit = decisions per month)
...
def get_plan_limits(plan_name: str) -> PlanLimits:
    ...
    Args:
        plan_name: Plan name (free, starter, pro, pro+, pro_plus, enterprise)
    ...
    if plan_name_lower in ("pro+", "proplus"):
        plan_name_lower = "pro_plus"
